    ...
    : QGLWidget(parent,mvcont->sharedDataContext()),interrbutshow(false)
{
   ...
   // connect(this, SIGNAL(resetTrackBallSignal()), this, SLOT(resetTrackBall()));
...
void GLArea::paintEvent(QPaintEvent* /*event*/)
{
    ...
    if (grabFrameView != "") {
        this->grabFrameBuffer().save(grabFrameView+".png");
        grabFrameView = "";
    }
}
...
void GLArea::setView()
{
    ...
    gluLookAt(0, cameraDist,0 , 0, 0, 0, 0, 0, 1);
}
