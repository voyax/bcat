...
{
	sliceWidget		= nullptr;
	growthChartWidget = nullptr;
	sliceDockWindow = nullptr;

	stageButtons.clear();
	stageButtons_shadow.clear();
	stageButtons.resize(10, nullptr);
	stageButtons_shadow.resize(10, nullptr);
	...
	// Switch between windows and keep your workspace up to date.
	//connect(windowMapper, SIGNAL(mapped(QWidget*)), this, SLOT(wrapSetActiveSubWindow(QWidget *)));
 
	// When switching between windows, update the status of toolbars and menus.
	...
	QIcon icon;
	icon.addPixmap(QPixmap(":images/TalentLandLogo48.png"));
	setWindowIcon(icon);
...
void MainWindow::createActions()
{
	...
	reloadMeshAct->setToolTip(tr("Reload Current Layer"));
	...
	reloadAllMeshAct->setToolTip(tr("Reload All Layers"));
...
//////////////Action Menu View ////////////////////////////////////////////////////////////////////////////
	...
	viewFrontAct = new QAction(QIcon(":/images/view_front.png"), tr("Front"), viewFromGroupAct);
	viewBackAct = new QAction(QIcon(":/images/view_back.png"), tr("Back"), viewFromGroupAct);
	viewRightAct = new QAction(QIcon(":/images/view_right.png"), tr("Right"), viewFromGroupAct);
	viewLeftAct = new QAction(QIcon(":/images/view_left.png"), tr("Left"), viewFromGroupAct);
	viewTopAct = new QAction(QIcon(":/images/view_top.png"), tr("Top"), viewFromGroupAct);
	...
	// 正交视角和透视视角的切换
	// 透视视角是近大远小，正交视角无透视效果（无消失点），适合正视图/侧视图等等。
	// See more: https://realism.com/blog/perspective-vs-orthographic-cameras
	// 通过改变fov（field of view，景深）也就是焦距来调整，默认是60，QT库里是在5和35之间切换。
	// 35mm最接近人眼透视效果。
...
void MainWindow::createToolBars()
{
	...
	mainToolBar->addAction(viewFrontAct);
	mainToolBar->addAction(viewBackAct);
	mainToolBar->addAction(viewLeftAct);
	mainToolBar->addAction(viewRightAct);
	mainToolBar->addAction(viewTopAct);
	mainToolBar->addSeparator();
