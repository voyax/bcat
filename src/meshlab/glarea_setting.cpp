...
{
	defaultGlobalParamSet.addParam(RichColor(backgroundBotColorParam(), QColor(255, 255, 255),"MeshLab Bottom BackGround Color","MeshLab GLarea's BackGround Color(bottom corner)"));
	defaultGlobalParamSet.addParam(RichColor(backgroundTopColorParam(), QColor(255, 255, 255),"MeshLab Top BackGround Color","MeshLab GLarea's BackGround Color(top corner)"));
	defaultGlobalParamSet.addParam(RichColor(logAreaColorParam(), QColor(255, 255, 255),"MeshLab GLarea's Log Area Color","MeshLab GLarea's BackGround Color(bottom corner)"));
