...
class VertexArityMax: public Arity13<vertex::EmptyCore<UserTypes>, A, B, C, D, E, F, G, H, I, J, K, L,M> {
...
template <class UserTypes,
		  ...
		  template <typename> class M = DefaultDeriver>
							class Vertex: public VertexArityMax<UserTypes, A, B, C, D, E, F, G, H, I, J, K, L, M>  {
